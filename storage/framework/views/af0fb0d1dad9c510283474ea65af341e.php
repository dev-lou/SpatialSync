...
<?php $__env->startSection('subtitle', 'Join the future of architectural collaboration.'); ?>

<?php $__env->startSection('content'); ?>
    <form method="POST" action="<?php echo e(route('register')); ?>" class="auth-form" id="register-form">
        <?php echo csrf_field(); ?>

        <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['label' => 'Full Name','name' => 'name','type' => 'text','placeholder' => 'John Smith','required' => true,'autocomplete' => 'name']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Full Name','name' => 'name','type' => 'text','placeholder' => 'John Smith','required' => true,'autocomplete' => 'name']); ?>
...
<?php endif; ?>
    ...
    <div class="auth-footer">
        Already have an account? <a href="<?php echo e(route('login')); ?>" style="color: var(--accent); font-weight: 600;">Sign in to workspace</a>
    </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\flow\resources\views/auth/register.blade.php ENDPATH**/ ?>