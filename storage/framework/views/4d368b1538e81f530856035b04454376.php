    ...
    <div style="max-width: 1000px; margin: 0 auto;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 380px; gap: var(--space-12); align-items: start;" 
            ...
            <div class="card glow-card reveal" style="padding: var(--space-10); border-radius: 32px;">
                <form action="<?php echo e(route('checkout.process')); ?>" method="POST" id="checkout-form" @submit="processing = true">
                    <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['label' => 'Cardholder Name','name' => 'card_name','value' => ''.e($auth_user_name ?? 'John Doe').'','placeholder' => 'John Doe','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Cardholder Name','name' => 'card_name','value' => ''.e($auth_user_name ?? 'John Doe').'','placeholder' => 'John Doe','required' => true]); ?>
...
<?php endif; ?>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-6);">
                            <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['label' => 'Expiry Date','name' => 'expiry','value' => '12/28','placeholder' => 'MM/YY','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Expiry Date','name' => 'expiry','value' => '12/28','placeholder' => 'MM/YY','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1)): ?>
<?php $attributes = $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1; ?>
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['label' => 'CVC','name' => 'cvc','value' => '123','placeholder' => '123','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'CVC','name' => 'cvc','value' => '123','placeholder' => '123','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1)): ?>
<?php $attributes = $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1; ?>
                    ...
                    <div style="margin-top: var(--space-10); padding-top: var(--space-8); border-top: 1px solid var(--border-default);">
                        <button type="submit" class="btn btn--primary btn--lg w-full btn-glow" :disabled="processing" style="justify-content: center; height: 64px; font-size: 1.125rem; gap: 12px;">
                            <template x-if="!processing">
                                <span>Upgrade to <?php echo e(ucfirst($plan)); ?> Plan</span>
                            </template>
                            <template x-if="processing">
                ...
                <div class="card" style="background: var(--bg-secondary); border-style: dashed; padding: var(--space-8); border-radius: 24px;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: var(--space-4);">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span style="color: var(--text-secondary);"><?php echo e(ucfirst($plan)); ?> Plan (Monthly)</span>
                            <span style="font-weight: 600;">$<?php echo e($amount); ?>.00</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div style="margin-top: var(--space-4); padding-top: var(--space-4); border-top: 1px solid var(--border-strong); display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span style="font-size: 1.5rem; font-weight: 900; color: var(--accent);">$<?php echo e($amount); ?>.00</span>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\flow\resources\views/checkout/index.blade.php ENDPATH**/ ?>