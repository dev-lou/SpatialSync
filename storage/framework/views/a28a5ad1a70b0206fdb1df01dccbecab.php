...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Editor'); ?> — SpatialSync</title>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            <?php if(session('success')): ?>
                showSweetToast("<?php echo e(session('success')); ?>", 'success');
            <?php endif; ?>
            <?php if(session('error')): ?>
                showSweetToast("<?php echo e(session('error')); ?>", 'error');
            <?php endif; ?>
            <?php if(session('info')): ?>
                showSweetToast("<?php echo e(session('info')); ?>", 'info');
            <?php endif; ?>
        });
    </script>
