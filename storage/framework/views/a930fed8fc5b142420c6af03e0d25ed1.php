...
<?php $__env->startSection('description', 'Simple, transparent pricing for SpatialSync. Start free and upgrade when you need more.'); ?>
...
<section class="pricing-hero">
    <div class="container">
        <div class="reveal">
            ...
            <?php if (isset($component)) { $__componentOriginalba280e4e561ac8f54b99891888439655 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalba280e4e561ac8f54b99891888439655 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pricing-toggle','data' => ['discount' => 20]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('pricing-toggle'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['discount' => 20]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalba280e4e561ac8f54b99891888439655)): ?>
<?php $attributes = $__attributesOriginalba280e4e561ac8f54b99891888439655; ?>
<?php unset($__attributesOriginalba280e4e561ac8f54b99891888439655); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalba280e4e561ac8f54b99891888439655)): ?>
<?php $component = $__componentOriginalba280e4e561ac8f54b99891888439655; ?>
<?php unset($__componentOriginalba280e4e561ac8f54b99891888439655); ?>
<?php endif; ?>
        </div>
    </div>
</section>
        ...
        <div class="pricing-grid stagger">
            ...
            <div class="pricing-card glow-card reveal">
                ...
                <div class="pricing-card__action">
                    <?php $isLoggedIn = (bool)session('supabase_user_id'); ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isLoggedIn && ($auth_user->plan ?? 'free') === 'free'): ?>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('register')); ?>" class="btn btn--secondary btn--lg w-full">
                            Get started free
                        </a>
            ...
            <div class="pricing-card pricing-card--featured glow-card reveal">
                ...
                <div class="pricing-card__action">
                    <?php $isLoggedIn = (bool)session('supabase_user_id'); ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isLoggedIn && ($auth_user->plan ?? 'free') === 'pro'): ?>
                        <button class="btn btn--primary btn--lg w-full" disabled style="opacity: 0.6; cursor: default;">
                            Your Current Plan
                        </button>
                    <?php else: ?>
                        <a href="<?php echo e($isLoggedIn ? route('checkout', 'pro') : route('register')); ?>" class="btn btn--primary btn--lg w-full btn-glow">
            ...
            <div class="pricing-card glow-card reveal">
                ...
                <div class="pricing-card__action">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('supabase_user_id') && ($auth_user->plan ?? 'free') === 'enterprise'): ?>
                        <button class="btn btn--secondary btn--lg w-full" disabled style="opacity: 0.6; cursor: default;">
                            Your Current Plan
                        </button>
                    <?php else: ?>
                        <a href="<?php echo e(route('contact.sales')); ?>" class="btn btn--secondary btn--lg w-full">
                            Contact sales
                        </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.faq-accordion','data' => ['items' => [
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('payment_success')): ?>
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script>
    document.addEventListener('DOMContentLoaded', function() {
        Swal.fire({
            title: 'Payment Successful!',
            text: "<?php echo e(session('payment_success')); ?>",
            icon: 'success',
            background: 'var(--surface)',
            color: 'var(--text-primary)',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\flow\resources\views/pricing.blade.php ENDPATH**/ ?>