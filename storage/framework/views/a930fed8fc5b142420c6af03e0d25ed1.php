...
<?php $__env->startSection('description', 'Simple, transparent pricing for ConstructHub. Start free and upgrade when you need more.'); ?>
    ...
    <div class="container">
        <div class="pricing-grid stagger">
            ...
            <div class="pricing-card pricing-card--featured glow-card reveal">
                ...
                <a href="<?php echo e(route('register')); ?>" class="btn btn--primary btn--lg w-full btn-glow">
